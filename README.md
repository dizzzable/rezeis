...
<p align="center">
  <a href="https://github.com/dizzzable/rezeis/releases/latest"><img src="https://img.shields.io/badge/version-0.2.12-blue" alt="Version" /></a>
...
docker pull ghcr.io/dizzzable/rezeis:0.2.12

# Pin to a minor line (gets 0.2.x updates automatically)
docker pull ghcr.io/dizzzable/rezeis:0.2
```

Доступные теги: `latest`, `0.2.12`, `0.2`, `v0.2.12`, плюс `sha-<short>` для каждого коммита в `main`.
