...
<p align="center">
  <a href="https://github.com/dizzzable/rezeis/releases/latest"><img src="https://img.shields.io/badge/version-0.2.13-blue" alt="Version" /></a>
...
docker pull ghcr.io/dizzzable/rezeis:0.2.13

# Pin to a minor line (gets 0.2.x updates automatically)
docker pull ghcr.io/dizzzable/rezeis:0.2
```

Доступные теги: `latest`, `0.2.13`, `0.2`, `v0.2.13`, плюс `sha-<short>` для каждого коммита в `main`.
