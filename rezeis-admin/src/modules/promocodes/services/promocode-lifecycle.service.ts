          ...
          this.events.error(
            ...
            `Promocode ${promocode.code} reward synced with delay (enqueue failed: ${message})`,
            {
              ...
              nextSteps:
                ...
                'откройте «Пользователи» → этого пользователя → вкладку «Подписки» и нажмите «Синхронизировать все» ' +
                '(не значок ↻ у подписки: тот забирает данные из Remnawave, а не отправляет).',
            },
          );
        }
      }
