 ...
 * itself. The tunable's ceiling was 2000 while every release caps `size` at
 * 1000. An operator could save 1500, the form and the PATCH
 ...
 *
 * The oracles are the contracts the releases rezeis serves ship, per the
 * vendor's own table (see `panel-command-conformance.spec.ts`).
 */
