...
export const en = {
  notificationsPage: {
    ...
    channels: {
      title: 'Telegram broadcast channels',
      description: 'Mirror user-notification events into Telegram chats or forum topics. Each channel can filter by event type.',
      create: 'New channel',
      createTitle: 'Create broadcast channel',
      editTitle: 'Edit broadcast channel',
      empty: 'No broadcast channels configured yet.',
      filterAll: 'Receives every event type',
      filterCount_one: 'Filtering {{count}} type: {{kinds}}{{more}}',
      filterCount_other: 'Filtering {{count}} types: {{kinds}}{{more}}',
      topic: 'Topic #{{id}}',
      inactive: 'Inactive',
      toggleActive: 'Toggle channel active',
      deleteConfirm: 'Delete this broadcast channel?',
      cancel: 'Cancel',
      save: 'Save',
      fields: {
        name: 'Name',
        namePlaceholder: 'Admin events',
        chatId: 'Chat ID',
        chatIdHint: 'Numeric Telegram chat id (group / channel / supergroup). Use @userinfobot or get it from getUpdates.',
        topicThreadId: 'Topic thread ID',
        topicThreadIdPlaceholder: 'Optional',
        topicThreadIdHint: 'Forum topic id when posting into a specific topic. Leave empty for the main chat.',
        kindFilter: 'Event types',
        kindFilterHint: 'One slug per line. Empty = receive every event. Examples: subscription.expired, partner.earning.',
        isActive: 'Active',
        isActiveHint: 'Inactive channels are skipped at fanout time.',
      },
      toasts: {
        created: 'Channel created',
        createFailed: 'Failed to create channel',
        updated: 'Channel saved',
        updateFailed: 'Failed to save channel',
