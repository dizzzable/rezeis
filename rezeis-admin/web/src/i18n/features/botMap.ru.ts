...
export const ru = {
  botMapPage: {
    ...
    notification: {
      ...
      lifetimeTopUpHint:
        'У бессрочной подписки продлевать нечего, поэтому кнопки этого уведомления, ведущие на «Продление подписки» (/renew), бот заменяет на «📦 Докупить трафик» → «Дополнения» (/addons) этой подписки. Push и колокольчик в кабинете ведут туда же. На схеме — отдельная стрелка.',
