...
export const en = {
  ...
  connectPageEditor: {
    ...
    saveWithTheme: 'Save the catalog and the theme',
    saved: 'Catalog saved',
    saveFailed: 'Could not save',
    ...
    theme: {
      ...
      description:
        'The connect screen can wear a concept of its own, separate from the cabinet theme. It follows the cabinet unless you pick one.',
      search: 'Search by name, code or family',
      inherit: 'Same as the cabinet',
      inheritHint: 'The same as everywhere else',
      inheritSwatch: 'cabinet theme',
      apply: 'Apply',
      unsaved: 'A theme is picked but not applied yet',
      featuredTitle: 'Colour of the "recommended" mark',
      featuredDefault: 'amber by default',
      featuredClear: 'Reset',
      featuredHint:
        'The dot in the top-left corner of the recommended app. Saved with the catalog, by the button at the top.',
      savedToast: 'Screen appearance saved',
      clearedToast: 'The screen follows the cabinet theme again',
      saveFailed: 'Could not save the appearance',
      noMatches: 'Nothing matched',
      previewLabel: 'What the subscriber sees',
      previewBrand: 'Your brand',
      previewEmpty: 'Add steps to see them here',
