...
export const ru = {
  ...
  connectPageEditor: {
    ...
    showKeys: 'Показывать ключи подключения',
    showKeysHint:
      'Сырые ключи на экране клиента. По умолчанию выключено: в кабинете человек уже авторизован, и это вопрос политики, а не удобства.',
    addPlatform: 'Добавить платформу',
    removePlatform: 'Удалить платформу',
