export const en = {
  ...
  contestsPage: {
    title: 'Contests',
    subtitle: 'An event with a draw at the end. The wheel is the permanent event; a contest is a temporary one',
    empty: 'No contests yet.',
    unnamed: 'Untitled',
    prizesCount_one: '{{count}} prize',
    prizesCount_few: '{{count}} prizes',
    prizesCount_many: '{{count}} prizes',
    prizesCount_other: '{{count}} prizes',
    awaitingDraw: 'Over — waiting for the draw',
    columns: {
      contest: 'Contest',
      window: 'Start / end',
      entries: 'Entries',
    ...
    drawRefused: {
      NOT_ACTIVE: 'The contest is not running — nothing to draw.',
      NOT_OVER: 'The contest is not over yet. The draw runs only after the end.',
    ...
    form: {
      ...
      startAt: 'Start',
      endAt: 'End and draw',
      maxEntries: 'Entry ceiling',
      noLimit: 'no ceiling',
      locked: 'The contest is running: people entered on these terms, so only the title and description may change.',
      prizes: 'Prizes',
      prizesHint: 'The first row is first prize. The draw is uniform: one entry per person, places handed out in draw order.',
      addPrize: 'Add a place',
      removePrize: 'Remove the place',
      place: 'Place {{place}}',
      prizeTitle: 'Prize title',
    },
    winners: {
      title: 'winners out of {{entrants}} entrants',
      empty: 'Nobody entered — there was nobody to draw from.',
      place: 'Place {{place}}',
    },
    deleteDialog: {
      title: 'Delete the draft?',
      description: 'Only a draft can be deleted. A running contest is cancelled instead.',
    },
    toast: {
      saved: 'Contest saved',
      deleted: 'Draft deleted',
      published: 'Contest published — entries are open',
      cancelled: 'Contest cancelled',
      drawn: 'Drawn: {{winners}} out of {{entrants}} entrants',
    },
  },
  wheelConfigPage: {
    promo: {
    ...
    disabled: 'Off',
    keysLeft: 'keys: {{count}}',
    perUser: 'Per person: {{count}}',
    total: 'Total: {{won}} of {{max}}',
    columns: {
      order: 'Order',
      sector: 'Sector',
      weight: 'Weight',
    ...
    kinds: {
      ...
      TRAFFIC: 'Traffic',
      DISCOUNT: 'Permanent discount',
      PROMOCODE: 'Promo code',
      KEY: 'Key from a pool',
      MANUAL: 'Handed over by an operator',
    },
    rarities: {
      COMMON: 'Common',
      RARE: 'Rare',
    ...
    settings: {
      enabled: 'Wheel is on',
      cooldown: 'Free spin, hours',
      cooldownHint: 'Empty means no free spins. The clock runs from the spin, not from midnight, which is why they never pile up.',
      price: 'Spin price in points',
      priceHint: 'Empty means spins cannot be bought with points.',
    },
    preview: {
      title: 'What the wheel looks like',
      note: 'This is the operator view: the percentages on the slices are yours alone.',
      empty: 'No enabled sectors with a weight.',
      unnamed: 'Sector',
    },
    economy: {
      title: 'Economy',
      returned: 'One spin returns {{value}} spins on average',
      total: 'One bought spin becomes roughly {{value}}',
      never: 'The spins never run out — the wheel cannot be switched on',
      spins: 'Spins so far: {{total}} · waiting on an operator: {{pending}}',
    },
    blockers: {
      title: 'The wheel cannot be switched on',
      NO_SECTORS: 'There is no enabled sector with a weight.',
      NO_LOSS_SECTOR:
        'A "no luck" sector must be enabled: it is the only one exempt from every ceiling, and without it somebody who has taken their one-off prizes is left with no sector available to them.',
      PERPETUAL:
        'The spins would never run out: one spin returns {{value}} on average. It has to be under one — lower the chance or the size of the sectors that pay spins.',
    },
    form: {
      kind: 'What it gives',
      rarity: 'Rarity',
      ...
      titleEn: 'Title (EN)',
      weight: 'Weight',
      weightHint: 'Not a percent: the percent is derived as a share of the total weight. Zero means the sector is on the wheel but never drawn.',
      pool: 'Key pool',
      poolPlaceholder: 'Pick a pool',
      instructions: 'What the operator has to do',
      instructionsPlaceholder: 'For example: get in touch and send 1000 RUB to the card',
      instructionsHint: 'The operator reads this in the prize queue. The winner never sees it.',
      perUser: 'Per-person limit',
      totalLimit: 'Total limit',
      noLimit: 'no limit',
      lossNoLimits: 'The "no luck" sector has no limits: it must stay available to everybody, always.',
      enabled: 'Sector is on',
    },
    deleteDialog: {
      title: 'Delete the sector?',
      description: 'The spin history survives: every spin keeps a snapshot of the sector as it was when it was won.',
    },
    toast: {
      saved: 'Sector saved',
  ...
  supportTicketsPage: {
    ...
    openTicket: {
      ...
      userHint:
        'Telegram ID, @username or Reiwa ID. If an @username matches more than one account the ticket is refused — use the Telegram ID.',
      subjectLabel: 'Subject',
      subjectPlaceholder: 'For example: a question about your payment',
      subjectHint: 'The client sees the subject in their ticket list and in the notification.',
      messageLabel: 'First message',
      messagePlaceholder: 'The text the client will read…',
      submit: 'Open ticket',
    },
    detail: {
      ...
      idPrefix: 'Reiwa ID',
      close: 'Close',
      purge: 'Delete files ({{count}})',
      purgeHint: 'Delete the files themselves and reclaim the disk. The record of what was sent, and when, stays.',
      purgeConfirm:
        'Delete every file on this ticket? Disk space is reclaimed. The attachment records stay; the files cannot be recovered.',
      attachmentPurged: '— file removed',
      reopen: 'Reopen',
    ...
    toast: {
      ...
      ticketOpened: 'Ticket opened and sent to the client',
      ticketOpenFailed: 'Could not open the ticket',
      replyFailed: 'Failed to send reply',
      closed: 'Ticket closed',
      reopened: 'Ticket reopened',
      deviceSilenced: 'That device can no longer write anonymously',
      deviceSilenceFailed: 'Could not silence the device',
      attachmentsPurged: 'Files deleted: {{count}}. Freed {{size}}',
      attachmentsPurgeFailed: 'Could not delete the files',
    ...
    config: {
      ...
      purgeOnClose: 'Delete files when a ticket is closed',
      purgeOnCloseHint:
        'Off by default. Closing a ticket removes its files from disk. The attachment records stay, so the thread still shows a file was sent and removed. The files cannot be recovered.',
  ...
  copyableId: {
    ...
    copied: '{{label}} copied',
    copyFailed:
      'Could not copy {{label}}: the browser did not allow access to the clipboard. The value is below — select it and copy it by hand.',
    copiedPlain: 'Copied',
    copyFailedPlain:
  ...
  paymentsPage: {
    ...
    transactions: {
      ...
      gatewayId: 'Payment system ID',
      details: 'Details',
      open: 'Open payment {{id}}',
    ...
    filters: {
      ...
      search: 'Payment',
      searchPlaceholder: 'Payment ID, payment system ID or record ID',
      client: 'Client',
      subscription: 'Subscription',
      removeClient: 'Show payments of every client',
      removeSubscription: 'Show payments of every subscription',
      status: 'Status',
      gateway: 'Gateway',
      type: 'Purchase type',
      dateFrom: 'Date from',
    ...
    details: {
      ...
      notFound: 'No payment has this number',
      notFoundHint:
        'The search covers the payment ID, the payment system ID and the record ID, and needs the whole value.',
      ambiguous: 'Several payments carry this number ({{count}})',
      ambiguousHint:
        'Different payment systems, or different platforms the payments were imported from, gave them the same number. Open them as a list and pick the right one.',
      showMatches: 'Show them in the list',
      idsTitle: 'Identifiers',
      paymentId: 'Payment ID',
      paymentIdHint: 'Ours. Sent to the payment system as the order number.',
      gatewayId: 'Payment system ID',
      gatewayIdHint: "The payment system's own number — the one their support asks for.",
      gatewayIdMissing: 'Not assigned yet',
      recordId: 'Record ID',
      recordIdHint: "The payment's row in the panel database.",
      ...
      delivery: {
        ...
        noStamp: 'No record of delivery',
      },
      planTitle: 'Plan at purchase',
      planEmpty: 'No plan snapshot was saved with this payment.',
      planName: 'Plan',
      planTerm: 'Term',
      planDays_one: '{{count}} day',
      planDays_other: '{{count}} days',
      planRaw: 'Full snapshot',
      clientTitle: 'Client',
      clientUnnamed: 'No name',
      clientId: 'Client ID',
      clientTelegram: 'Telegram ID',
      clientEmail: 'Email',
      openClient: 'Open user card',
      clientPayments: 'All client payments',
      subscriptionTitle: 'Subscription',
      subscriptionId: 'Subscription ID',
      subscriptionPayments: 'All payments for this subscription',
      subscriptionNone:
        'No subscription is linked to this payment. A new purchase gets one once it is paid and delivered.',
      combinedRenewal_one: 'Combined renewal: {{count}} subscription',
      combinedRenewal_other: 'Combined renewal: {{count}} subscriptions',
      subscriptionInCard: 'Subscriptions are managed in the user card, on the Subscriptions tab.',
      webhooksTitle: 'Webhooks for this payment',
      webhooksRestricted:
        'This is not "no webhooks arrived": the events come under a different permission that your role does not have, so nothing was requested.',
      webhooksFailed: 'Webhook events could not be loaded. This does not mean none arrived.',
      webhooksEmpty: 'No webhooks have arrived for this payment.',
      webhookReceived: 'Received {{time}}',
  ...
  subscriptionsPage: {
    ...
    openPayments: 'Payments for subscription {{id}}',
    stats: {
      total: 'Total',
      active: 'Active',
      trial: 'Trial',
  ...
  brandingPage: {
    ...
    sections: {
      ...
      dashboardIcons: {
        ...
        description:
          'The row of round buttons above the subscription card: swap the picture, switch on an attention effect, set the colour. An untouched icon stores nothing and looks exactly as before.',
        glyphLabel: 'Picture',
