...
export type PaymentGatewayType = 'TELEGRAM_STARS' | 'YOOKASSA' | 'YOOMONEY' | 'CRYPTOMUS' | 'HELEKET' | 'CRYPTOPAY' | 'TBANK' | 'ROBOKASSA' | 'STRIPE' | 'MULENPAY' | 'CLOUDPAYMENTS' | 'PAL24' | 'WATA' | 'PLATEGA';
