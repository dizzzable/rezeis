...
-- AddForeignKey
ALTER TABLE "subscription_reset_epochs" ADD CONSTRAINT "subscription_reset_epochs_term_id_fkey" FOREIGN KEY ("term_id") REFERENCES "subscription_terms"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "add_on_entitlements" ADD CONSTRAINT "add_on_entitlements_expiry_epoch_id_fkey" FOREIGN KEY ("expiry_epoch_id") REFERENCES "subscription_reset_epochs"("id") ON DELETE SET NULL ON UPDATE CASCADE;
